...
namespace IdentityServer.Data.Migrations
{
    ...
    [Migration("20210810125237_ChangeSeededMigration")]
    partial class ChangeSeededMigration
    {
            ...
            modelBuilder.Entity("IdentityServer.Data.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2021, 8, 10, 14, 52, 36, 144, DateTimeKind.Local).AddTicks(7462),
                            Name = "SuperMarket",
                            NameAr = "سوبرماركت"
                        });
                });
            ...
            modelBuilder.Entity("IdentityServer.Data.Entities.Entity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2021, 8, 10, 14, 52, 36, 144, DateTimeKind.Local).AddTicks(9053),
                            Name = "Momkn",
                            NameAr = "ممكن"
                        });
                });
            ...
            modelBuilder.Entity("IdentityServer.Data.Entities.UserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2021, 8, 10, 14, 52, 36, 141, DateTimeKind.Local).AddTicks(5237),
                            Name = "AccountUser"
                        });
                });
