...
namespace IdentityServer.Data.Migrations
{
    ...
    [Migration("20211124094205_AddProviderSMSEntity")]
    partial class AddProviderSMSEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityServer.Data.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2021, 11, 24, 11, 42, 5, 498, DateTimeKind.Local).AddTicks(9429),
                            Name = "General",
                            NameAr = "عام"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2021, 11, 24, 11, 42, 5, 498, DateTimeKind.Local).AddTicks(9468),
                            Name = "SuperMarket",
                            NameAr = "سوبرماركت"
                        });
                });
            ...
            modelBuilder.Entity("IdentityServer.Data.Entities.Entity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2021, 11, 24, 11, 42, 5, 499, DateTimeKind.Local).AddTicks(254),
                            Name = "Momkn",
                            NameAr = "ممكن"
                        });
                });
            ...
            modelBuilder.Entity("IdentityServer.Data.Entities.ProviderSMS", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProviderSMS");
                });

            modelBuilder.Entity("IdentityServer.Data.Entities.ProviderSMSParams", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("ProviderSMSID")
                        .IsUnique();

                    b.ToTable("ProviderSMSParams");
                });
            ...
            modelBuilder.Entity("IdentityServer.Data.Entities.UserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreationDate = new DateTime(2021, 11, 24, 11, 42, 5, 497, DateTimeKind.Local).AddTicks(531),
                            Name = "ConsumerAccount"
                        },
                        new
                        {
                            ID = 2,
                            CreationDate = new DateTime(2021, 11, 24, 11, 42, 5, 498, DateTimeKind.Local).AddTicks(452),
                            Name = "AdminAccount"
                        },
                        new
                        {
                            ID = 11,
                            CreationDate = new DateTime(2021, 11, 24, 11, 42, 5, 498, DateTimeKind.Local).AddTicks(474),
                            Name = "Company"
                        });
                });
            ...
            modelBuilder.Entity("IdentityServer.Data.Entities.ProviderSMSParams", b =>
                {
                    b.HasOne("IdentityServer.Data.Entities.ProviderSMS", "ProviderSMS")
                        .WithOne("ProviderSMSParams")
                        .HasForeignKey("IdentityServer.Data.Entities.ProviderSMSParams", "ProviderSMSID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
